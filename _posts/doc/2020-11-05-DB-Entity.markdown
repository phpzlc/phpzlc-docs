...
prev_page: /doc/db/start
next_page: /doc/db/edit
description_auto: 0
description: Symfony设计Entity
tags: symfony,phpzlc,entity
---
...
2. 高级用法
   ...
   **支持`@AddRule`注释,利用规则注释可以为其成功执行提供必要的保证。**
   ...
   _具体更多的知识,可以通过学习[高级查询-规则章节](/doc/repository/rule)来了解。_
   ...
   _具体更多的知识,可以通过学习[规则-高级用法](/doc/repository/rule-advanced-usage#定义新规则重写规则)来了解。_
