...
## 模式切换
   ...
   **场景**
   ...
   $this->adminStrategy->setMenuModel($menu_model) // 简单模式 menu_model_simple = 2; 复杂模式 menu_model_all = 1; 
   ```
...
## 仪表盘基本写法
   ...
   **页面层**
   ...
   [代码参考模板](https://github.com/phpzlc/demo-blog/blob/master/templates/page/statistical-station.html.twig)
...
## 列表页面基本写法
   ...
   **页面层**
   ...
   [代码参考模板](https://github.com/phpzlc/demo-blog/blob/master/templates/page/list.html.twig)
...
## 编辑页面基本写法
   ...
   **页面层**
   ...
   [代码参考模板](https://github.com/phpzlc/demo-blog/blob/master/templates/page/edit.html.twig)
