...
我们提供全局变量参数，来改变后台环境显示.例如,内测环境;开发模式环境;样品环境;正式环境
...
1. 内测环境(配置地址.env.local)
   ...
   ![效果](/assets/posts/admin/beta.png)
...
3. 样品环境(配置地址.env.local)
   ...
   ![效果](/assets/posts/admin/demo.png)
...
4. 正式环境(配置地址.env.local)
   ...
   ![效果](/assets/posts/admin/prod.png)
