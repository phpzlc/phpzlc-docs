...
!function () {
  ...
  t = window, m = {
    ...
    searchResultTemplate: '<div class="post-1552 post type-post status-publish format-standard has-post-thumbnail hentry category-blog blog-list-div">\n' +
      '                                <div class="content">\n' +
      '                                    <h4 class="post-title mb-3">\n' +
      '                                        <a href="{url}" class="content"> {title}</a>\n' +
      // '                                           <p class="post-details">' +
      // '                                              <span class="author">作者：{author_no}</span>' +
      // '                                              <span class="release-time">时间：{date | date: "%Y-%m-%d"}</span>' +
      // '                                              <span class="number">文章来源：xx</span>' +
      // '                                              <a href="{url}" class="last-span">阅读全文</a>' +
      // '                                           </p>' +
      '                                    </h4>\n' +
      '\n' +
  ...
  }({ required: v = ["searchInput", "resultsContainer", "json"] }), t.SimpleJekyllSearch = function (t) {
    var n;
