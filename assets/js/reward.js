...
reward.prototype._hide = function() {
  this.popbg.hide();
  this.popcon.hide();
};
reward.prototype._show = function() {
  this.popbg.show();
  this.popcon.show();
  this.zsBtns.show();
  this.zsFooter.show();
...
reward.prototype._init = function() {
  var that = this;
  ...
  this.zsbtn.each(function(el) {
    $(this).on("click", function() {
      ...
      //根据不同付款方式和选择对应的按钮的数字来显示对应的二维码图片
      var src = "/assets/images/pay/" + type + "-" + num + ".png"; //图片路径
      var text = $(this).html();
